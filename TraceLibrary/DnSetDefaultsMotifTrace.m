...
function [param] = DnSetDefaultsMotifTrace()
...
% flagged controls
                    ...
                    param.basis.N            = 300;                     % No of kernels in the basis set

%% General Parameters

                    param.genpars.dt         = 1;           % dt in millisecond
                    param.genpars.startbasis = -100;
...
%                   Gain function params:      default linear
                    ...
                    param.basis.const        = 1;                   % for both
                    param.basis.tau          = 8000;                    % If exponential, decay
